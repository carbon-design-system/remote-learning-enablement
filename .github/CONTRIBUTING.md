...
1. Fork the project by navigating to the main [repository](https://github.com/carbon-design-system/remote-learning-enablement) and clicking the **Fork** button on the top-right corner.

2. Navigate to your forked repository and copy the **SSH url**. Clone your fork by running the following in your terminal:

   ```
   $ git clone git@github.com:{ YOUR_USERNAME }/remote-learning-enablement.git
   $ cd remote-learning-enablement
   ```

   See [GitHub docs](https://help.github.com/articles/fork-a-repo/) for more details on forking a repository.

3. Once cloned, you will see `origin` as your default remote, pointing to your personal forked repository. Add a remote named `upstream` pointing to the main `remote-learning-enablement`:

   ```
   $ git remote add upstream git@github.com:carbon-design-system/remote-learning-enablement.git
   $ git remote -v
   ```
   ...
   upstream	   git@github.com/carbon-design-system/remote-learning-enablement.git (fetch)
   upstream	   git@github.com/carbon-design-system/remote-learning-enablement.git (push)
   ```
...
8. In GitHub, navigate to [carbon-design-system/remote-learning-enablement](https://github.com/carbon-design-system/remote-learning-enablement) and click the button that reads "Compare & pull request".
