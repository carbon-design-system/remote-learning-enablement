...
import mobile from './images/leader-mobile-banner.jpg';
import desktop from './images/leader-desktop-banner.jpg';
...
![illustration](images/for-leaders-contenttop.png)
...
| -- | -- | -- |
| Classrooms & parent conferences |	A smaller group interacting with a leader |	[Video conferencing](tools-and-resources/classroom-and-parent-conferences) |
| Lectures & assemblies 	| Address a large group with limited interaction | 	[Video streaming (also enables on-demand viewing of topics)](tools-and-resources/lectures-and-assemblies)| 
| Messaging with students | 	Chat with the whole class or smaller groups of students, share resources | [Instant messaging and group chats](tools-and-resources/messaging-with-students)| 
